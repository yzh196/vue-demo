                ...
                <li v-for="item in List" :key="item.productId">
                  <div class="cart-tab-1">
                    <div class="cart-item-check">
                      <a class="item-check-btn" :class="{'check':item.checked}" @click="changeCheck(item)">
                    ...
                    <div class="item-include">
                      <dl>
                        <dt>赠送:</dt>
                        <dd v-for="gift in item.parts" :key="gift.partsId">{{gift.partsName}}</dd>
                      </dl>
                    </div>
                  </div>
                  ...
                  <div class="cart-tab-5">
                    <div class="cart-item-operation">
                      <a  class="item-edit-btn"  @click="delProduct(item)">
          ...
          <div class="cart-foot-wrap">
            <div class="cart-foot-l">
              <div class="item-all-check" >
                <a class="item-check-btn" :class="{'check': checkallFlag}" @click="checkall(true)">
                  <svg class="icon icon-ok"><use xlink:href="#icon-ok"></use></svg>
                </a>
                <span>全选</span>
              </div>
      ...
      <div class="md-modal-inner">
        ...
        <div class="md-content">
          ...
          <div class="btn-wrap col-2">
            <button class="btn btn--m" id="btnModalConfirm" @click="confirmDelProduct">Yes</button>
            <button class="btn btn--m btn--red" id="btnModalCancel" @click="delFlag=false">No</button>
          </div>
        </div>
      </div>
    </div>
    <div class="md-overlay" v-show="delFlag" @click="delFlag=false" id="showOverLay"></div>
  </div>
</template>
